...
<form action="/home/{usere}/create" method="post">
    ...
    <div class='container'>
        ...
        <input type="string" name='title' value="<?php echo e(old('title')); ?>">
    </div>
...
<!-- For the message -->
    ...
    <textarea type="areatext" class="areatext" name='message'value="<?php echo e(old('message')); ?>"></textarea>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\social\resources\views/postes/create.blade.php ENDPATH**/ ?>